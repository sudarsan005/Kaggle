# -*- coding: utf-8 -*-
"""
Created on Mon Oct 12 15:37:00 2015
...
train = pd.read_csv("train.csv", dtype={"Age": np.float64, "Fare": np.float64}, )
test = pd.read_csv("test.csv", dtype={"Age": np.float64, "Fare": np.float64}, )


df_X, df_Y = preprocess_data(train)
df_test    = preprocess_data(test, extract_Y=False)
#df_test,df_test_Y    = preprocess_data(test)
